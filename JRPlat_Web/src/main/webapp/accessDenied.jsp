    ...
    <tr>
        <td height="200" align="center" valign="top" background="<%=basePath%>/images/error_bg.jpg">
            <table width="80%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td width="34%" align="right"><img src="<%=basePath%>/images/error.gif" width="128" height="128">
                    </td>
                    <td width="66%" valign="bottom" align="center">
                        ...
                        <a href="#"
                           onclick="javascript:document.location.href='<%=basePath%>/j_spring_security_logout';">重新登录</a>
                    </td>
            </table>
        </td>
    </tr>
