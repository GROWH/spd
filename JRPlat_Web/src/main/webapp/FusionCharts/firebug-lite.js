        ...
        this.getDOMMembers = function (object) {
            ...
            try {
                if (this.instanceOf(object, "Window")) {
                    ...
                    if (object instanceof Document || object instanceof XMLDocument) {
                            ...
                            if (object instanceof HTMLImageElement) {
                                ...
                                if (object instanceof HTMLAnchorElement) {
                                    ...
                                    if (object instanceof HTMLInputElement) {
                                        ...
                                        if (object instanceof HTMLButtonElement) {
                                            ...
                                            if (object instanceof HTMLFormElement) {
                                                ...
                                                if (object instanceof HTMLBodyElement) {
                                                    ...
                                                    if (object instanceof HTMLHtmlElement) {
                                                        return domMemberCache.HTMLHtmlElement
                                                    } else {
                                                        if (object instanceof HTMLScriptElement) {
                                                            return domMemberCache.HTMLScriptElement
                                                        } else {
                                                            if (object instanceof HTMLTableElement) {
                                                                return domMemberCache.HTMLTableElement
                                                            } else {
                                                                if (object instanceof HTMLTableRowElement) {
                                                                    return domMemberCache.HTMLTableRowElement
                                                                } else {
                                                                    if (object instanceof HTMLTableCellElement) {
                                                                        return domMemberCache.HTMLTableCellElement
                                                                    } else {
                                                                        if (object instanceof HTMLIFrameElement) {
                                                                            ...
                                                                            if (object instanceof SVGSVGElement) {
                                                                                ...
                                                                                if (object instanceof SVGElement) {
                                                                                    ...
                                                                                    if (object instanceof Element) {
                                                                                        ...
                                                                                        if (object instanceof Text || object instanceof CDATASection) {
                                                                                            ...
                                                                                            if (object instanceof Attr) {
                                                                                                ...
                                                                                                if (object instanceof Node) {
                                                                                                    ...
                                                                                                    if (object instanceof Event || object instanceof EventCopy) {
            ...
            append(ChromeBase, {
                    ...
                    var firebugOptionsMenu = {
                        id: "fbFirebugOptionsMenu", getItems: function () {
                            ...
                            return [{
                                ...
                                disabled: cookiesDisabled
                            }, "-", {label: "Restore Options", command: "restorePrefs", disabled: cookiesDisabled}]
                ...
                initialize: function () {
                    if (Env.bookmarletOutdated) {
                        Firebug.Console.logFormatted(["A new bookmarlet version is available. Please visit http://getfirebug.com/firebuglite and update it."], Firebug.browser, "warn")
                    }
                    if (Firebug.Console) {
    ...
    var FirebugReps = FBL.ns(function () {
        with (FBL) {
            ...
            this.Obj = domplate(Firebug.Rep, {
                tag: OBJECTLINK(SPAN({"class": "objectTitle"}, "$object|getTitle"), FOR("prop", "$object|propIterator", " $prop.name=", SPAN({"class": "objectPropValue"}, "$prop.value|cropString"))),
                propIterator: function (object) {
                    ...
                    try {
                        for (var name in object) {
                            ...
                            var t = typeof val;
                            if (t == "boolean" || t == "number" || (t == "string" && val) || (t == "object" && !isFunction(val) && val && val.toString)) {
                                var title = (t == "object") ? Firebug.getRep(val).getTitle(val) : val + "";
    ...
    FBL.ns(function () {
        with (FBL) {
            ...
            Firebug.InlineEditor.prototype = domplate(Firebug.BaseEditor, {
                ...
                outerMargin: 8,
                shadowExpand: 7,
                tag: DIV({"class": "inlineEditor"}, DIV({"class": "textEditorTop1"}, DIV({"class": "textEditorTop2"})), DIV({"class": "textEditorInner1"}, DIV({"class": "textEditorInner2"}, INPUT({
                ...
                }))), DIV({"class": "textEditorBottom1"}, DIV({"class": "textEditorBottom2"}))),
                inputTag: INPUT({
                    "class": "textEditorInner",
                    type: "text",
                    onkeypress: "$onKeyPress",
            ...
            var XMLHttpRequestWrapper = function (activeXObject) {
                ...
                var finishXHR = function () {
                    ...
                    for (var i = 0, l = responses.length;
                        ...
                        if (match) {
                            spy.responseHeaders.push({name: [match[1]], value: [match[2]]})
                        }
                    }
                    with ({
                        row: spy.logRow,
        ...
        with (FBL) {
            ...
            Firebug.NetMonitor.NetInfoPostData = domplate(Firebug.Rep, {
                ...
                jsonTable: TABLE({
                    ...
                    cellspacing: 0,
                    role: "presentation"
                }, TBODY({role: "list", "aria-label": $STR("jsonviewer.tab.JSON")}, TR({
                    "class": "netInfoPostJSONTitle",
                    role: "presentation"
                }, TD({role: "presentation"}, DIV({"class": "netInfoPostParams"}, $STR("jsonviewer.tab.JSON")))), TR(TD({"class": "netInfoPostJSONBody"})))),
                xmlTable: TABLE({
        ...
        with (FBL) {
            ...
            Firebug.HTML.onListMouseMove = function onListMouseMove(e) {
                try {
                    ...
                    if (typeof targ.attributes[FBL.cacheID] == "undefined") {
                        return
                    }
