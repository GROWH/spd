...
<%@page import="org.jrplat.module.security.service.OnlineUserService" %>
<%@page import="org.jrplat.module.security.service.SpringSecurityService" %>
<%@page import="org.jrplat.module.security.service.UserDetailsServiceImpl" %>
<%@page import="org.jrplat.module.system.service.PropertyHolder" %>
<%@page import="org.jrplat.platform.util.SpringContextUtils" %>
...
//供记录用户登录日志使用
    ...
    String appSupport = PropertyHolder.getProperty("app.support");
    String requestCode = "";
...
<head>
    ...
    <script type="text/javascript">
        ...
        var appName = '<%=appName%>';
        var appSupport = '<%=appSupport%>';
        var loginCode =<%=PropertyHolder.getBooleanProperty("login.code")%>;
        //服务器当前时间
        var serverNowDate = '<%=new SimpleDateFormat("yyyy-MM-dd HH:mm").format(Calendar.getInstance().getTime())%>';
        var clientNowDate = new Date().format('Y-m-d H:i');
        var actualNowDate = serverNowDate === clientNowDate ? clientNowDate : serverNowDate;
...
<img id="bgImg" src="images/login_bg.jpg" height="100%" width="100%"/>
<div id="loading-mask">
    <div id="loading">
        <div style="text-align:center;padding-top:26%"><img alt="Loading..." src="images/extanim32.gif" width="32"
