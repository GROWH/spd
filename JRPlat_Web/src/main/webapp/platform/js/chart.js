...
ChartBaseModel = function () {
    return {
        ...
        getChartData: function (url, category, queryString) {
            ...
            conn.open("POST", url + category + "&temp=" + new Date(), false);
            conn.send(null);
            xml = conn.responseText;
            tip.hide();
            return xml;
        },
        ...
        show: function (windowTitle, windowIcon, topHeight, url, category, queryString, type, dataTypeLabel, dataTypeItems, dataTypeColumns, dataTypeHeight) {
            ...
            var chartTypeItems = [
                ...
                {boxLabel: '', id: 'Pareto3D', name: "chartType", inputValue: 'Pareto3D', checked: type == 'Pareto3D'},
                {
                    ...
                    id: 'Doughnut2D',
                    name: "chartType",
                    inputValue: 'Doughnut2D',
                    checked: type == 'Doughnut2D'
                },
                {
                    boxLabel: '',
                    id: 'Doughnut3D',
                    name: "chartType",
                    inputValue: 'Doughnut3D',
                    checked: type == 'Doughnut3D'
                }
            ];
            ...
            var chartTypeItems = [
                {
                    ...
                    id: "MSColumn2D",
                    name: "chartType",
                    inputValue: 'MSColumn2D',
                    checked: type == 'MSColumn2D'
                },
                {
                    boxLabel: '',
                    id: "MSColumn3D",
                    name: "chartType",
                    inputValue: 'MSColumn3D',
                    checked: type == 'MSColumn3D'
                },
                ...
                {boxLabel: '', id: "MSArea", name: "chartType", inputValue: 'MSArea', checked: type == 'MSArea'},
                {
                    ...
                    id: "StackedArea2D",
                    name: "chartType",
                    inputValue: 'StackedArea2D',
                    checked: type == 'StackedArea2D'
                },
                {
                    boxLabel: '',
                    id: "StackedColumn3D",
                    name: "chartType",
                    inputValue: 'StackedColumn3D',
                    checked: type == 'StackedColumn3D'
                },
                {
                    boxLabel: '',
                    id: "StackedColumn2D",
                    name: "chartType",
                    inputValue: 'StackedColumn2D',
                    checked: type == 'StackedColumn2D'
                },
                {
                    boxLabel: '',
                    id: "StackedBar2D",
                    name: "chartType",
                    inputValue: 'StackedBar2D',
                    checked: type == 'StackedBar2D'
                },
                {
                    boxLabel: '',
                    id: "StackedBar3D",
                    name: "chartType",
                    inputValue: 'StackedBar3D',
                    checked: type == 'StackedBar3D'
                },
                {
                    boxLabel: '',
                    id: "Marimekko",
                    name: "chartType",
                    inputValue: 'Marimekko',
                    checked: type == 'Marimekko'
                },
                {
                    boxLabel: '',
                    id: "ScrollStackedColumn2D",
                    name: "chartType",
                    inputValue: 'ScrollStackedColumn2D',
                    checked: type == 'ScrollStackedColumn2D'
                },
                {
                    boxLabel: '',
                    id: "ScrollColumn2D",
                    name: "chartType",
                    inputValue: 'ScrollColumn2D',
                    checked: type == 'ScrollColumn2D'
                },
                {
                    boxLabel: '',
                    id: "ScrollArea2D",
                    name: "chartType",
                    inputValue: 'ScrollArea2D',
                    checked: type == 'ScrollArea2D'
                },
                {
                    boxLabel: '',
                    id: "ScrollCombi2D",
                    name: "chartType",
                    inputValue: 'ScrollCombi2D',
                    checked: type == 'ScrollCombi2D'
                },
                {
                    boxLabel: '',
                    id: "ScrollLine2D",
                    name: "chartType",
                    inputValue: 'ScrollLine2D',
                    checked: type == 'ScrollLine2D'
                },
