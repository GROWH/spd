OtherGridModelTwo = function() {
    return {
        ...
        getStore : function(fields, pageSize) {
            ...
            var store = new Ext.data.Store({
                ...
                proxy : new parent.Ext.data.HttpProxy({
                    ...
                    + this.action + '!popupQuery.action' + OtherGridModelTwo.initUrlParams
                })
            });
            store.on('beforeload', function(store) {
                store.baseParams = {
                    propertyCriteria : OtherGridModelTwo.propertyCriteria,
                    likeQueryInfo: OtherGridModelTwo.likeQueryInfo,
                    likeQueryType: OtherGridModelTwo.queryAction,
                    queryaction : OtherGridModelTwo.queryAction + 'Action'
                };
            });
         ...
         * @param initUrlParams
         * @param disabledPage  禁用分页combo 可通过getGrid(..., disabledPage) 或 OtherGridModelTwo.disabledPage设置
        ...
        getGrid : function(namespace, action, queryAction, fields, columns, propertyCriteria, initUrlParams, disabledPage) {
            ...
            this.grid = new Ext.grid.EditorGridPanel({
                ...
                listeners: {
                    destroy: function () {
                        OtherGridModelTwo.propertyCriteria = '';
                        OtherGridModelTwo.likeQueryInfo = '';
                        OtherGridModelTwo.initUrlParams = '';
                    }
                }
