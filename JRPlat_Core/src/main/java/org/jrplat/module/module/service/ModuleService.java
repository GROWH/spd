...
import org.jrplat.module.security.service.PrivilegeUtils;
...
public class ModuleService {
    private static final JRPlatLogger LOG = JRPlatLoggerFactory.getJRPlatLogger(ModuleService.class);
    ...
    public static List<String> getCommandPath(Command command) {
        ...
        //JRPlat是支持任意多级的模块嵌套的，虽然目前的DEMO中只有两级
        //对于以下的路径来说：
        //http://jrplat.net/security/user!query.action
        //query是命令
        //user是模块
        //security也是模块
