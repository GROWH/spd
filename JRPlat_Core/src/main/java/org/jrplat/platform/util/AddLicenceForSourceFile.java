...
public class AddLicenceForSourceFile {
    ...
    public static void processJavaFile() {
        ...
        addLicenceForJavaFile(new File(JRPLATPATH), JAVALICENSE);
    ...
    public static void processJspFile() {
        ...
        addLicenceForJspFile(new File(JRPLATPATH), JSPLICENSE);
    ...
    public static void processJsFile() {
        ...
        addLicenceForJsFile(new File(JRPLATPATH), JSLICENSE);
