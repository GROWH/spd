...
public class GzipFilter extends Filter {
    private static final JRPlatLogger LOG = JRPlatLoggerFactory.getJRPlatLogger(GzipFilter.class);
...
class GenericResponseWrapper extends HttpServletResponseWrapper implements Serializable {
    ...
    private static final JRPlatLogger LOG = JRPlatLoggerFactory.getJRPlatLogger(GenericResponseWrapper.class);
...
class ResponseUtil {
    private static final JRPlatLogger LOG = JRPlatLoggerFactory.getJRPlatLogger(ResponseUtil.class);
...
abstract class Filter implements javax.servlet.Filter {
    ...
    private static final JRPlatLogger LOG = JRPlatLoggerFactory.getJRPlatLogger(Filter.class);
