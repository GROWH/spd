 ...
 */
public class JRPlatLocalContainerEntityManagerFactoryBean extends AbstractEntityManagerFactoryBean
        implements ResourceLoaderAware, LoadTimeWeaverAware {

    private final JRPlatPersistenceUnitManager internalPersistenceUnitManager =
            new JRPlatPersistenceUnitManager();
     ...
     *                               that this JRPlatLocalContainerEntityManagerFactoryBean should parse
