...
public class ElasticSearchLogHandler implements LogHandler {
    private static final JRPlatLogger LOG = JRPlatLoggerFactory.getJRPlatLogger(ElasticSearchLogHandler.class);
    ...
    public static void main(String[] args) {
        ...
        //curl  -XGET http://localhost:9200/jrplat_for_log/_search?pretty=true&q=ysc
    }
